...
//import icon
import { BsCheckCircleFill, BsGear } from "react-icons/bs";
...
const PlanList = ({ plans }) => {
  ...
  return (
    <div
      className="flex flex-col lg:flex-row items-center justify-center max-w-[1280px] mx-auto 
    gap-y-4"
    >
      {plans.map((plan, currentIndex) => {
        ...
        return (
          ...
          >
            ...
            >
              <div
                className="flex flex-row lg:flex-col gap-x-8 gap-y-8 lg:gap-x-0 items-center
              "
              >
                {/*name & price wrapper */}
                <div>
                  ...
                  <div
                    className={`${
                      currentIndex === index
                        ...
                        : "bg-neutral-500 text-white"
                    } h-[26px] font-primary text-sm font-semibold 
                    min-w-min mx-auto px-[14px] flex items-center justify-center mb-8`}
                  >
                    {name}
                  </div>
                  {/* price */}
